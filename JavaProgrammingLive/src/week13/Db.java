...
public class Db {
    ...
    public void insetData(String s, int i){
        this.data = data; // we used "this" keyword only if our instance variable has same name with local variable(both of them 'data'
        yint = i;
    }
